...
mixin _$SeasonModel {
  ...
  String? get posterPathRaw => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      posterImage: freezed == posterImage
          ...
          : posterImage // ignore: cast_nullable_to_non_nullable
              as Uint8List?,
      posterPathRaw: freezed == posterPathRaw
          ? _value.posterPathRaw
          : posterPathRaw // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$SeasonModelImpl implements _SeasonModel {
  ...
  @override
  final String? posterPathRaw;

  @override
  String toString() {
    return 'SeasonModel(id: $id, name: $name, overview: $overview, airDate: $airDate, episodeNumber: $episodeNumber, voteAverage: $voteAverage, seasonNumber: $seasonNumber, posterImage: $posterImage, posterPathRaw: $posterPathRaw)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.posterPathRaw, posterPathRaw) ||
                other.posterPathRaw == posterPathRaw));
  }
...
abstract class _SeasonModel implements SeasonModel {
  const factory _SeasonModel(
      ...
      final String? posterPathRaw}) = _$SeasonModelImpl;
